package languages{
	...
	public final class Language_RU extends Language_SHELL
	{
		...
		public static function getStrings():Array {
			...
			addInterfaceElem('l_info','«Построитель графиков» позволяет мгновенно строить до 10 графиков функций одновременно. Если тебе понравилось это приложение, приглашай друзей!');
			...
			addInterfaceElem('b_stop', 'Остановить');
			...
			addError('wrong_number_of_dots','Поле с количеством точек построения должно содержать целое число, это число обязано быть в диапазоне от %0 до %1.');
